...
class CategoryPage(base_page.BasePage):
    ...
    def is_prose(self):
        assert self.hover_action(*locators.CategoryPageLocators.PROSE), \
    ...
    def is_classic(self):
        assert self.hover_action(*locators.CategoryPageLocators.CLASSIC), \
    ...
    def is_novels(self):
        assert self.hover_action(*locators.CategoryPageLocators.NOVELS), \
    ...
    def is_collection(self):
        assert self.hover_action(*locators.CategoryPageLocators.COLLECTION), \
    ...
    def is_modern(self):
        ...
        assert self.hover_action(*locators.CategoryPageLocators.MODERN), \
            "Button 'modern' is not present"
        print(f"{inspect.currentframe().f_code.co_name} - OK")
    ...
    def is_page_1_category(self):
        assert self.hover_action(*locators.CategoryPageLocators.PAGE_1_CATEGORY), \
    ...
    def is_page_2_category(self):
        assert self.hover_action(*locators.CategoryPageLocators.PAGE_2_CATEGORY), \
    ...
    def is_page_3_category(self):
        assert self.hover_action(*locators.CategoryPageLocators.PAGE_3_CATEGORY), \
    ...
    def is_page_4_category(self):
        assert self.hover_action(*locators.CategoryPageLocators.PAGE_4_CATEGORY), \
    ...
    def is_page_5_category(self):
        assert self.hover_action(*locators.CategoryPageLocators.PAGE_5_CATEGORY), \
    ...
    def is_sort_button(self):
        ...
        assert self.click_element(*locators.CategoryPageLocators.SORT_BUTTON), \
            "Button 'sort_button' is not present"
        self.explicitly_wait(1)
        print(f"{inspect.currentframe().f_code.co_name} - OK")
    ...
    def is_on_page_button(self):
        ...
        assert self.click_element(*locators.CategoryPageLocators.ON_PAGE_BUTTON), \
            "Button 'on_page_button' is not present"
        self.explicitly_wait(1)
        print(f"{inspect.currentframe().f_code.co_name} - OK")
